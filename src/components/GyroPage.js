...
function GyroPage() {
  ...
  const handleEditToggle = () => {
    ...
    if (isEditing) {
      setSimData((prev) => ({
        ...prev,
        heading: parseFloat(editData.heading) || 0,
      ...
      setEditData({
        heading: String(simData.heading),
        pitch: String(simData.pitch),
        roll: String(simData.roll),
      });
      setIsEditing(true);
    }
  };
  ...
  const renderGyroStatusImage = () => {
    switch (simData.status) {
      case "Active":
        return <img src={Active} alt="Active" className="status-image" />;
      case "Stop":
        return <img src={Stop} alt="Stop" className="status-image" />;
      default:
        ...
        <div className="data-display-panel">
          ...
          <div className="gyro-visuals-container">
            ...
            <div className="gyro-card">
              <div className="card-header">
                <div className="card-title">
                  <img src={Frame1} alt="Heading Icon" />
                  <span>Heading</span>
                </div>
              ...
              <div className="card-footer heading-rate-control">
                ...
                <div className="rate-control-group">
                  <button
                    ...
                    onClick={handleDecreaseHeadingRate}
                  >
                    ◀
                  </button>
                  ...
                  <button
                    ...
                    onClick={handleIncreaseHeadingRate}
                  >
                    ▶
                  </button>
                </div>
